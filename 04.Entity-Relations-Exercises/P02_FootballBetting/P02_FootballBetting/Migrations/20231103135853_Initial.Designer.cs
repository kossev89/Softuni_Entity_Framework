...
namespace P02_FootballBetting.Migrations
{
    ...
    [Migration("20231103135853_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GamePlayer", b =>
                {
                    b.Property<int>("PlayersStatisticsGameId")
                        .HasColumnType("int");

                    b.Property<int>("PlayersStatisticsPlayerId")
                        .HasColumnType("int");

                    b.HasKey("PlayersStatisticsGameId", "PlayersStatisticsPlayerId");

                    b.HasIndex("PlayersStatisticsPlayerId");
            ...
            modelBuilder.Entity("GamePlayer", b =>
                {
                    b.HasOne("P02_FootballBetting.Data.Models.Game", null)
                        .WithMany()
                        .HasForeignKey("PlayersStatisticsGameId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("P02_FootballBetting.Data.Models.Player", null)
                        .WithMany()
                        .HasForeignKey("PlayersStatisticsPlayerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("P02_FootballBetting.Data.Models.Color", b =>
                {
                    b.Navigation("PrimaryKits");

                    b.Navigation("SecondaryKits");
                });
